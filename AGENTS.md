...
6. For every stack directory, symlink the shared `.env` file into the stack directory:
...
7. If the stack should be managed through the helper targets, add it to [`docker/Makefile`](/home/jakobe/code/homelab/docker/Makefile).
